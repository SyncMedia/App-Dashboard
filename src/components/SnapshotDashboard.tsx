...
import { SColors, useDeepCompareEffect } from "@/utils";
...
const SnapshotDashboard = () => {
  ...
  const handleAppClick = (rtype: string, item: RankedItem) => {
    if (rtype === 'category') {
      ...
      console.log(`Clicked: ${rtype}, item: ${item}`, item);
    }
  };
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <RankedList
              ...
              data={topOpenedApps}
              onItemClick={(item) => handleAppClick('app', item)}
            />
            <RankedList
              title={
                <div className="flex items-center gap-2">
